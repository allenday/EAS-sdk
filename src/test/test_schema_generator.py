...
class TestSchemaGenerator:
    ...
    def test_eas_to_protobuf_type_mapping(self):
        ...
        assert eas_to_protobuf_type(EASType("unknown_type", [], False)) == "string"  # Default fallback
  ...
  repeated uint64 amounts = 3;
    ...
    def test_generate_proto_format_with_complex_types(self):
        ...
        with pytest.raises(ValueError, match="Protobuf generation does not support complex types with fixed dimensions"):
