...
class EASType:
    ...
    def to_protobuf_type(self) -> str:
        ...
        type_mapping = {
            ...
            'bytes32': 'bytes',
            'bytes': 'bytes',
            'uint8': 'uint32', 'uint16': 'uint32', 'uint24': 'uint32', 'uint32': 'uint32',
            'uint40': 'uint64', 'uint48': 'uint64', 'uint56': 'uint64', 'uint64': 'uint64',
            'uint72': 'uint64', 'uint80': 'uint64', 'uint88': 'uint64', 'uint96': 'uint64',
            'uint104': 'uint64', 'uint112': 'uint64', 'uint120': 'uint64', 'uint128': 'uint64',
            'uint136': 'uint64', 'uint144': 'uint64', 'uint152': 'uint64', 'uint160': 'uint64',
            'uint168': 'uint64', 'uint176': 'uint64', 'uint184': 'uint64', 'uint192': 'uint64',
            'uint200': 'uint64', 'uint208': 'uint64', 'uint216': 'uint64', 'uint224': 'uint64',
            'uint232': 'uint64', 'uint240': 'uint64', 'uint248': 'uint64', 'uint256': 'uint64',
            'int8': 'int32', 'int16': 'int32', 'int24': 'int32', 'int32': 'int32',
            'int40': 'int64', 'int48': 'int64', 'int56': 'int64', 'int64': 'int64',
            'int72': 'int64', 'int80': 'int64', 'int88': 'int64', 'int96': 'int64',
            'int104': 'int64', 'int112': 'int64', 'int120': 'int64', 'int128': 'int64',
            'int136': 'int64', 'int144': 'int64', 'int152': 'int64', 'int160': 'int64',
            'int168': 'int64', 'int176': 'int64', 'int184': 'int64', 'int192': 'int64',
            'int200': 'int64', 'int208': 'int64', 'int216': 'int64', 'int224': 'int64',
            'int232': 'int64', 'int240': 'int64', 'int248': 'int64', 'int256': 'int64',
        }
...
class EASTypeParser:
    ...
    FIELD_PATTERN = re.compile(r'^([a-zA-Z][a-zA-Z0-9]*(?:\[\d+\])*(?:\[\])?)\s+([a-zA-Z_][a-zA-Z0-9_]*)$')
