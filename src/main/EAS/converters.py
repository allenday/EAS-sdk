...
def filtering_converter(allowed_fields: Set[str]) -> AttestationConverter[Dict[str, Any]]:
    """
...
def transforming_converter(transformations: Dict[str, callable]) -> AttestationConverter[Dict[str, Any]]:
    """
